    ...
    <div className="fixed w-full top-0 lg:top-[1rem] left-0 z-30">
      ...
      >
        ...
        <ul className="hidden lg:flex flex-1 gap-8 ml-10">
          <li className="text-lg font-light hover:underline cursor-pointer text-white">
            Solutions
          </li>
          <Link to="/pricing">
            <li className="text-lg font-light hover:underline cursor-pointer text-white">
        ...
        <div className="hidden lg:block space-x-2">
          <Link to="/contact">
            <button className="px-4 py-2 border border-white rounded-full bg-white text-black ease-in-out duration-500 hover:bg-transparent hover:text-white">
              Book a Free Demo
            </button>
          </Link>
          <Link to="/contact">
        ...
        {auth?.id && (
          <div className="ml-4 cursor-pointer" onClick={() => setShowUserDetailsMenu(prev => !prev)}>
