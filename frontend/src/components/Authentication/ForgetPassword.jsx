...
const ForgetPassword = () => {
  ...
  return (
    <div className="text-center flex-1 py-10 flex flex-col items-center justify-center">
      <h1 className="text-[#24243e] text-4xl mb-10">Reset Password</h1>
      ...
      {isOTPVerified && (
        <form onSubmit={resetPasswordHandler} className="space-y-3">
          ...
          <div className="pt-4">
            <button
              type="submit"
              className="w-[14rem] mb-2 lg:mb-0 lg:w-[14rem] py-1 lg:py-2 text-lg border border-[#2e2a5b] text-white bg-[#2e2a5b] rounded-full font-light hover:bg-white hover:text-[#2e2a5b] ease-in-out duration-300 mr-2"
            >
              Reset Password
            </button>
          </div>
