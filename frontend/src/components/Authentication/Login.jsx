...
const Login = ({
  ...
  return (
    <div className="text-center flex-1 py-10 flex flex-col items-center justify-center">
      <h1 className="text-[#24243e] text-4xl mb-10">Login</h1>
      ...
      <form className="space-y-3" onSubmit={handleLogin}>
        ...
        <div className="pt-4">
          <button
            ...
            className="w-[12rem] lg:w-[12rem] py-1 lg:py-2 text-lg border border-[#2e2a5b] text-white bg-[#2e2a5b] rounded-full font-light hover:bg-white hover:text-[#2e2a5b] ease-in-out duration-300 mr-2"
          >
            Forget Password?
          </button>
          <button className="w-[8rem] lg:w-[8rem] py-1 lg:py-2 text-lg border border-[#2e2a5b] text-white bg-[#2e2a5b] rounded-full font-light hover:bg-white hover:text-[#2e2a5b] ease-in-out duration-300">
            Login
          </button>
        </div>
