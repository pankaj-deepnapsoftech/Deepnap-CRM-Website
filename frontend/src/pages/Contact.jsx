...
const Contact = () => {
  ...
  const sendQueryHandler = async (e) => {
    ...
    try {
      const url = process.env.REACT_APP_SUPPORT_BACKEND_URL + "create-support";
  ...
  return (
    <div className="relative contact pt-36">
      <div className="">
        <h1 className="text-4xl font-medium text-[#262544] text-center mb-10">
          Have Some Questions?
        </h1>
        ...
        <div className="flex flex-col md:flex-row px-10 justify-center items-center gap-10">
          ...
          <div className="w-[23rem] md:w-[30rem] border rounded px-2 md:px-5 py-5 md:py-10 bg-white">
            <h1 className="text-3xl font-medium text-[#262544] text-center mb-6 md:mb-12">
            ...
            <form onSubmit={sendQueryHandler}>
              <div className="flex flex-col gap-2 mb-5">
                ...
                <input
                  ...
                  required
                  placeholder="Name"
                  className="text-lg font-light border outline-none rounded-md px-3 py-[6px]"
                  type="text"
                />
              </div>
              <div className="flex flex-col gap-2 mb-5">
              ...
              <div className="flex flex-col gap-2 mb-5">
                ...
                <select
                  ...
                  required
                  className="text-lg font-light border outline-none rounded-md px-3 py-[8px]"
                  type="text"
                >
              ...
              <div className="w-full pt-3">
                <button
                  ...
                  className="text-white border w-full py-2 text-lg font-light rounded-full ease-in-out duration-500 hover:scale-105"
                >
                  Contact Us
                </button>
              </div>
